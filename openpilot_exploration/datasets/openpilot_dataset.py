...
from openpilot_exploration.custom_logreader.custom_logreader import LogReader, ReadMode
from openpilot_exploration.openpilot_common.constants import SupercomboInputShapes
from openpilot_exploration.openpilot_common.rlog_types import (
    XYZT,
...
class OpenpilotDataset(Dataset):
    def __init__(
        self,
        folder: str,
        ...
        """Constructor for the OpenpilotDataset class.
