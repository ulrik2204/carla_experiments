...
class OpendriveGenerationParameters:
    ...
    def __init__(
        ...
        :param vertex_distance: (float)

        :param max_road_length: (float)

        :param wall_height: (float)

        :param additional_width: (float)

        :param smooth_junctions: (bool)

        :param enable_mesh_visibility: (bool)

        :param enable_pedestrian_navigation: (bool)
        """
        ...
...
class VehiclePhysicsControl:
    ...
    def __init__(
        ...
        forward_gears: list[GearPhysicsControl] = list(),
        drag_coefficient: float = 0.3,
        center_of_mass: Vector3D = Vector3D(0.0, 0.0, 0.0),
        steering_curve: List[Vector2D] = [Vector2D(0.0, 1.0), Vector2D(10.0, 0.5)],
        wheels: list[WheelPhysicsControl] = list(),
