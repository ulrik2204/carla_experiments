...
COMMA_CAR_SEGMENTS_REPO = os.environ.get(
    "COMMA_CAR_SEGMENTS_REPO",
...
COMMA_CAR_SEGMENTS_LFS_INSTANCE = os.environ.get(
    "COMMA_CAR_SEGMENTS_LFS_INSTANCE", COMMA_CAR_SEGMENTS_REPO
)
...
def get_lfs_file_url(oid, size):
    ...
    response = requests.post(
        f"{COMMA_CAR_SEGMENTS_LFS_INSTANCE}.git/info/lfs/objects/batch",
        json=data,
        headers=headers,
    )
